...
class VaristorsPage(BasePage):
    ...
    varistors_sub_nav_tab = {"by": By.ID, "value": 'subSubNav_7-link'}
    ...
    varistors_devices_page_slick_list = {"by": By.CSS_SELECTOR,
                                             "value": '#panel1c > div.category-tiles > div > div > div'}
    all_varistors_sub_category = {"by": By.CSS_SELECTOR,
    ...
    def click_on_the_varistors_sub_nav(self):
        self._click(self.varistors_sub_nav_tab)
    ...
    def varistors_category_slick_list_is_displayed(self):
        return self._is_displayed(self.varistors_devices_page_slick_list)

    def all_varistors_devices_displayed(self):
        return self._is_displayed(self.all_varistors_sub_category)
