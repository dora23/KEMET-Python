...
class SuperCapacitorsPage(BasePage):
    ...
    supercapacitors_category = {"by": By.CSS_SELECTOR,
                                "value": '#subSubNav_1 > div.header__sub-nav-content > ul > li:nth-child(6) > a'}
    supercapacitors_page_slick_list = {"by": By.CSS_SELECTOR,
                                       "value": '#panel1c > div.category-tiles > div > div > div'}
    all_supercapacitors_sub_category = {"by": By.CSS_SELECTOR,
    ...
    def click_on_supercapacitors_category(self):
        self._click(self.supercapacitors_category)

    def supercapacitors_category_slick_list_is_displayed(self):
        return self._is_displayed(self.supercapacitors_page_slick_list)
