...
class PulseTransformersPage(BasePage):
    ...
    pulse_transformers_category = {"by": By.CSS_SELECTOR,
                                   "value": '#subSubNav_2 > div.header__sub-nav-content > ul > li:nth-child(7) > a'}
    ...
    def click_on_pulse_transformers_category(self):
        self._click(self.pulse_transformers_category)
