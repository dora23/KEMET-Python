...
class DcChokesPage(BasePage):
    ...
    dc_chokes_category = {"by": By.CSS_SELECTOR,
                          "value": '#subSubNav_2 > div.header__sub-nav-content > ul > li:nth-child(2) > a'}
    ...
    dc_chokes_page_slick_list = {"by": By.CSS_SELECTOR, "value": '#panel1c > div.category-tiles > div > div > div'}
    all_dc_chokes_sub_category = {"by": By.CSS_SELECTOR,
    ...
    def click_on_dc_chokes_category(self):
        self._click(self.dc_chokes_category)
    ...
    def dc_chokes_category_slick_list_is_displayed(self):
        return self._is_displayed(self.dc_chokes_page_slick_list)

    def all_dc_chokes_displayed(self):
        return self._is_displayed(self.all_dc_chokes_sub_category)

    def get_dc_chokes_slick_list_items(self):
        elems = self.driver.find_elements_by_css_selector('div.category-tiles__item')
        return elems

    def get_dc_chokes_slick_list_items_count(self):
        return len(self.get_dc_chokes_slick_list_items())
