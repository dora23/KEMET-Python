...
class FerriteBeadsPage(BasePage):
    ...
    ferrite_beads_category = {"by": By.CSS_SELECTOR,
                          "value": '#subSubNav_2 > div.header__sub-nav-content > ul > li:nth-child(4) > a'}
    ...
    def click_on_ferrite_beads_category(self):
        self._click(self.ferrite_beads_category)
