...
class FerriteMaterialsPage(BasePage):
    ...
    ferrite_materials_category = {"by": By.CSS_SELECTOR,
                                  "value": '#subSubNav_2 > div.header__sub-nav-content > ul > li:nth-child(8) > a'}
    ...
    def click_on_ferrite_materials_category(self):
        self._click(self.ferrite_materials_category)
