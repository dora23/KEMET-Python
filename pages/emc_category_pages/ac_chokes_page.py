...
class AcChokesPage(BasePage):
    ...
    ac_chokes_category = {"by": By.CSS_SELECTOR,
                          "value": '#subSubNav_2 > div.header__sub-nav-content > ul > li:nth-child(1) > a'}
    ...
    def click_on_ac_chokes_category(self):
        self._click(self.ac_chokes_category)
